...
export default {
  ...
  methods: {
    ...
    insertAptSource() {
      ...
      source_api.insert(this.insertSourceName.trim(), this.insertSourceUrl.trim(), 'APT')
        .then(response => {
          this.$message({
            message: '添加成功',
            type: 'success'
    ...
    refreshPage() {
      ...
      source_api.getAptSourceListByPage(this.currentPage, this.pageSize).then(response => {
        this.list = response.data
        this.listLoading = false
      })
    }
